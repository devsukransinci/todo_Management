...
import com.devsukran.todo.exception.ResourceNotFoundException;
...
public class TodoServiceImpl implements TodoService {
    ...
    public TodoDto updateTodo(TodoDto todoDto, Long id) {
      Todo todo = todoRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Todo not with id : " + id));
    ...
    public TodoDto completedTodo(Long id) {
     Todo todo = todoRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("Todo not found wit id :" +id));
